...
plt.plot(final_dist, label = r'Sum av {} fuglekasser.'.format(terms_in_sum1), linewidth = 2.5)
plt.grid(True)
plt.tight_layout()
...
plt.plot(final_dist, label = r'Sum av {} fuglekasser.'.format(terms_in_sum1+terms_in_sum2), linewidth = 2.5)
...
plt.plot(final_dist, label = r'Sum av {} fuglekasser.'.format(terms_in_sum1+terms_in_sum2+terms_in_sum3), linewidth = 2.5)
