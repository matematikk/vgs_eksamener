...
\begin{easylist}[enumerate]
	...
	\end{equation*}
	Settes $S(r)$ lik svaret i a) (dette kan man for eksempel gjøre i CAS), fås $r\approx 0.74$. $r$ er vekstfaktoren i uttrykket, så ulippet må endres med $1-r$. Bedriften må \answer{redusere utslippet hvert år med omtrent $27 \, \%$} for at bedriftene skal slippe ut det samme over samme periode.
\end{easylist}
