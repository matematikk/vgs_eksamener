...
\newtcbtheorem[number within=section]{boxDef}{Definisjon}%
{colback=white!5,colframe=blue!70!black,fonttitle=\bfseries}{section}
\newtcbtheorem[number within=section]{boxTheo}{Teorem}%
{colback=white!5,colframe=green!75!black,fonttitle=\bfseries}{section}
\newtcbtheorem[number within=section]{boxCol}{Korollar}%
{colback=white!5,colframe=red!80!black,fonttitle=\bfseries}{section}
\newtcbtheorem[number within=section]{boxLemma}{Lemma}%
{colback=white!5,colframe=yellow!90!black,fonttitle=\bfseries}{section}
...
\newtheorem{proposition}{Proposisjon}[section]
...
\renewcommand*{\proofname}{\textbf{Bevis}} 
